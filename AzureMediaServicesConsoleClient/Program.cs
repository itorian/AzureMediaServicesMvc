...
namespace AzureMediaServicesConsoleClient
{
    class Program
    {
        private static readonly string _supportFiles = Path.GetFullPath(@"../..\supportFiles");

        private static readonly string _singleInputFilePath = Path.GetFullPath(_supportFiles + @"\inputfiles\TestClip.mp4");
        private static readonly string _outputFilesFolder = Path.GetFullPath(_supportFiles + @"\outputfiles");

        private static readonly string _accountName = "csharpcornerdemo";
        private static readonly string _accountKey = "CHknIGnsNKvgagK2f3XwSHztKDk6VHUCwNwZB6wSviM=";
